...
//    tEnv.executeSql("insert into printSinkTable select * from mysqlSourceTable")
//    tEnv.executeSql("select * from printSinkTable").print()
    ...
    var insertSql = "insert into writeMysqlTable select * from mysqlSourceTable"
